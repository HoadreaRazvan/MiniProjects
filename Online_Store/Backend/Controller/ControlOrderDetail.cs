...
namespace Backend.Controller
{
    public class ControlOrderDetail
    {
        ...
        public ControlOrderDetail(string path)
        {
        ...
        public void load(string path)
        {
            ...
            StreamReader fisier = new StreamReader($@"{path}Resources\orderDetailFile.txt");
            string linie = "";
        ...
        {
            StreamWriter fisier = new StreamWriter($@"{path}Resources\orderDetailFile.txt");
