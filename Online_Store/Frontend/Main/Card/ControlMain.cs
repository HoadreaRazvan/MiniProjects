...
namespace Frontend
{
    public class ControlMain : Panel
    {
        ...
        public ControlMain(Order order, Customer customer, Form form, int buttonsBar, string search)
        {
            ...
            this.controlProducts = new ControlProduct(Application.StartupPath);
            this.controlOrder = new ControlOrder(Application.StartupPath);
            this.controlOrderDetail = new ControlOrderDetail(Application.StartupPath);
            this.controlCustomer = new ControlCustomer(Application.StartupPath);
        ...
        public void addCos_Click(object sender, EventArgs e)
        {
            ...
            this.controlOrderDetail.save(Application.StartupPath);
            this.controlOrderDetail.load(Application.StartupPath);
